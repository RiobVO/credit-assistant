...
5. **T3.1** Observability — GlitchTip on-prem (Sentry SaaS нельзя — PROJECT_BRIEF Sec 8) либо plain logs + SIEM. Backend + frontend `error.tsx` hook. ADR-0022. Зависит от T3.2 (correlation_id для tags).
