...
- TODO[CA-029]: парсеры FORM_1_BALANCE_SHEET (assets/liabilities) и PROFIT_TAX (taxes_paid) — пока adapter raises UnsupportedFormatError для них. По образцу FORM_2 (CA-026) + реальные xltx папы.
