...
2. ~~**T3.4** Postgres backup~~ ✅ **DONE 2026-05-18** — `backup_postgres.sh` + `restore_drill.sh` + sidecar `docker-compose.backup.yml` + playbook `docs/operations/db-backup.md` (3 prod destinations + encryption setup + disaster scenarios).
