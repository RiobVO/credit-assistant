...
class AuditLogORM(Base):
    ...
    # T1.4 (ADR-0018): brand-tenant метка для forensics. NOT NULL DEFAULT
    # 'default' — backfill для existing rows + страховка на случай миграции
    # без указания brand_id в insert.
